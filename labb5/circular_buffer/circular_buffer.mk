...
##
## Debug
ProjectName            :=circular_buffer
ConfigurationName      :=Debug
WorkspacePath          :=Z:/EDA482_snake/labb5
ProjectPath            :=Z:/EDA482_snake/labb5/circular_buffer
...
ObjectsFileList        :="circular_buffer.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/circular_buffer.elf ./Debug/circular_buffer.s19
	arm-none-eabi-objdump -D -S ./Debug/circular_buffer.elf > ./Debug/circular_buffer.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "Z:/EDA482_snake/labb5/circular_buffer/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
